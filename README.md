...
Absolutely KISS Monitoring tool with no special sauce. Just Bash scripts, piping to a central server via SSH. No Database, no dashboard setup. Run one command to setup.
