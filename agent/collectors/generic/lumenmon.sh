...
while true; do
    ...
    # Publish all three metrics
    publish_metric "generic_sys_os" "\"$os\"" "TEXT"
    publish_metric "generic_sys_kernel" "\"$kernel\"" "TEXT"
    publish_metric "generic_sys_uptime" "$uptime" "INTEGER"
