...
show_completion() {
    ...
    if [ -n "$invite_url" ]; then
        ...
        echo "Install agent on target machine (bare metal, no Docker needed):"
        echo ""
        echo "  curl -sSL $GITHUB_RAW/agent/install.sh | bash"
        echo "  lumenmon-agent register '$invite_url'"
        echo "  lumenmon-agent start"
        echo ""
        echo "Or generate new invites anytime with: lumenmon invite"
        echo ""
        echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
        echo ""
    fi
